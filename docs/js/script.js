...
const STORY_SCRIPT = [
  ...
  { type: 'narration', text: '【沈临渡的内心独白】' },
  { type: 'thought', speaker: '沈临渡', text: '我坐在最后一排，装睡。' },
  { type: 'thought', speaker: '沈临渡', text: '前面那个戴眼镜的女生——叫裴听——刚刚回头看了我一眼。然后转过去跟同桌说了句话。我没听清。只看到她的嘴型。像是在说——"他知道了。"' },
  ...
  { type: 'narration', text: 'Scene 02 · 陆砚' },
  { type: 'narration', text: '语文课。课堂骚动了一阵才安静下来。陆砚站在讲台上，白衬衫，第二颗扣子开着。' },
  { type: 'narration', text: '他今年二十六岁，全校最年轻的优秀教师。讲台上讲《离骚》原文，温和得像一泓静水。教导主任都说——"小陆这人，稳当。"' },
  { type: 'thought', speaker: '沈临渡', text: '我不知道为什么。我总觉得那个"稳当"是装出来的。当然，也可能是我想多了。' },
  { type: 'thought', speaker: '沈临渡', text: '我只是隐隐约约觉得——他在看我的时候，目光比看别人多停半秒。' },
  { type: 'narration', text: '那天放学后，我无意间经过教师公寓楼下。陆砚蹲在花坛边，在捡一本被风吹散的备课本。他抬头看到我，愣了一下。就一下。然后笑了。' },
  { type: 'dialogue', speaker: '陆砚', text: '"沈临渡？放学了怎么还不回去？"' },
  ...
  { type: 'dialogue', speaker: '沈临渡', text: '"陆老师。你上次讲《爱莲说》，说周敦颐写\'出淤泥而不染，濯清涟而不妖\'——是说君子即使处在不干净的环境里，也要保持高洁。可是陆老师，如果一个人，他自己就不干净呢？他还有资格当君子吗？"' },
  ...
  { type: 'thought', speaker: '沈临渡', text: '他什么都没说。但那个沉默不是拒绝。是——他不知道该怎么回答。' },
  ...
  { type: 'thought', speaker: '沈临渡', text: '她在看。她一直在看。不只是看成绩单——她在看我的思路。' },
  { type: 'jump', label: 'k_continue' },

  { type: 'label', name: 'k_star' },
  { type: 'narration', text: '笔记本第二天回来了。那颗星星旁边，她画了一颗更小的星星。像是某种心照不宣的信号。' },
  { type: 'thought', speaker: '沈临渡', text: '我们什么都没说。但笔记本每天都在传。那些公式和批注，比任何语言都诚实。' },
  ...
  { type: 'dialogue', speaker: '陆砚', text: '"论坛的事，我跟年级组说了。你不必跟任何人解释。"' },
  ...
  { type: 'dialogue', speaker: '陆砚', text: '"我只是——正好有盒牛奶。正好你在这里。"' },
  { type: 'narration', text: '他撒谎。我们俩都知道他在撒谎。但那个谎——太温柔了。' },
  { type: 'jump', label: 'c04_merge' },

  { type: 'label', name: 'c04_thanks' },
  { type: 'dialogue', speaker: '沈临渡', text: '"……谢谢。"' },
  ...
  { type: 'narration', text: '开学了。新学期。裴听把最后一本笔记放在沈临渡桌上。跟以前一样——夹子夹着，标签贴着，红笔和黑笔。' },
  ...
  { type: 'narration', text: '裴海生终究被调查了。裴苑没有亲口告诉沈临渡——是他自己查到的。市场监管局的案卷里，举报信的格式和裴苑那个律所一模一样。' },
  { type: 'narration', text: '毕业前他找到她。' },
  { type: 'dialogue', speaker: '沈临渡', text: '"为什么？"' },
  ...
  { type: 'bg', value: 'riverbank' },
  { type: 'narration', text: '【EXTRA · 陆砚的梦】' },
  { type: 'narration', text: '那是一个很短的梦。' },
  { type: 'narration', text: '梦里没有声音。只有沈临渡在河堤上喝草莓牛奶的样子。他喝得很慢。眼睛里有光。' },
